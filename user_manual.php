    ...
    <div class="container">
        <div class="row">
            <div class=col>
                ...
                <h2><a href="signin.php"></a>Great Come on and Sign In</h2>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col" id="Landing">
                ...
                <img src="images\lpic1.png" alt="" style="height:330px;width:750px">
                <img src="images\lpic2.png" alt="" style="height:330px;width:750px">
                <img src="images\lpic3.png" alt="" style="height:330px;width:750px">
                <img src="images\lpic4.png" alt="" style="height:330px;width:750px">
            </div>
        </div>
        <br>
        <hr>
        <div class="row">
            <div class="col" id="Landing">
                ...
                <p> On the top navigation bar of the landing page, click login, you will be redirected to the login page.<br>
                    To continue further, you must enter your email address and password.<br>
                    If you have forgotten your password,click on the "forgot password" link. </p>
                <img src="images\loginpage.png" alt="" style="height:330px;width:700px">
            </div>
        </div>
        <br>
        <hr>
        <div class="row">
            <div class="col" id="Landing">
                ...
                <img src="images\sign-up.png" alt="" style="height:330px;width:700px">
            </div>
        </div>
        <br>
        <hr>
        <div class="row">
            <div class="col" id="Landing">
                ...
                <img src="images\dashboardImg.png" alt="" style="height:400px;width:770px">
            </div>
        </div>
        <br>
        <hr>
        <div class="row">
            <div class="col" id="Landing">
                ...
                <img src="images\chat.png" alt="" style="height:330px;width:700px">
            </div>
        </div>
        <br>
        <hr>
        <div class="row">
            <div class="col" id="Landing">
                ...
                <img src="images\help-page.png" alt="" style="height:330px;width:700px">
            </div>
        </div>
        <br>
        <hr>
        <div class="row">
            <div class="col" id="Landing">
                ...
                <img src="images\contacts.png" alt="" style="height:330px;width:700px">
            </div>
        </div>
        <br>
        <hr>
        <div class="row">
            <div class="col" id="Landing">
                ...
                <img src="images\profile1.png" alt="" style="height:330px;width:700px">
            </div>
        </div>
        <br>
        <hr>
        <div class="row">
            <div class="col" id="Landing">
                ...
                <img src="images\repository.png" alt="" style="height:330px;width:700px">
            </div>
        </div>
        <div class="row">
            <div class="col" id="Landing">
                <h2><a href="signin.php">Great Come on and Sign In</a></h2>
            </div>
        </div>
        <br>
        <hr>
