...
?>
    ...
    <head>
        ...
        <title>Personal Chat Home</title>
    </head>

    <script>
        const app_user = JSON.parse(`<?= json_encode($user) ?>`)
        let chat_user = JSON.parse(`<?= json_encode($chat_user) ?>`)
    </script>
                    ...
                    <div class="row">
                        <div id="chat-profile" class="col-md-12 right-header">
                            <div class="right-header-img">
                                <img src="<?= $chat_user->profile_pic ?>" alt="<?= $chat_user->profile_pic ?>">
                            </div>
                            <div class="right-header-detail">
                                <div>
                                    <p><?= $chat_user->fullname ?></p>
                                    <span><?= $chat_user->is_parent ? "Parent" : "Teacher" ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 right-chat-textbox">
                            <form id="message-form">
                                ...
                                <input id="message-input" autocomplete="off" type="text" name="message" data-receiver="<?= $chat_user->id ?>" data-sender="<?= $user->id ?>" placeholder="Write your message...">
