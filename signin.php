    ...
    <div class="signin-form">
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input id="email" type="text" class="form-control" placeholder="someone@site.com" name="email" autocomplete="off" required="required">
            </div>
            <div class="form-group">
                <label for="pass">Password</label>
                <input id="pass" type="password" class="form-control" placeholder="Password" name="pass" autocomplete="off" required="required">
            </div>
            <!-- <div class="small">Forgot password? <a href="forgot_pass.php">Click Here</a></div> -->
            <div class="text-center small" style='color:#67428B;'>Want to checkout our <a href="user_manual.php">User Manual</a>
                <br>
                <br>
                <div class="form-group">
